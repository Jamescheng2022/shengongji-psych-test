# Page 04 Poster Assets

This folder contains share-poster-only visual assets for `/poster`.

- `miniapp-code-placeholder.svg`: editable placeholder for the future WeChat mini program code. It is intentionally labeled as a placeholder and is not a real or simulated official WeChat code.
