...
- 主标题进一步放大，成为海报最大视觉焦点。
- 判词固定为标题下方的 1-2 行主文案，避免被人物图吞掉。
- 人物图扩大并用金环、红纱和底部渐隐融入背景。
- 六维图谱继续保留六维数据，但压缩为轻量细线，不再像分析面板。
- 二维码区域改为浅金卷轴托底，成为海报底部自然收口。
- 操作区主次简化：保存海报、分享命格、返回结果为主要可见操作，重新入宫降级为弱入口。
...
- 主标题、判词、人物、签语、最高倾向、六维和二维码形成连续纵向视觉链路。
